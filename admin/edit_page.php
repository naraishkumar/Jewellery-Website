    ...
    <div class="row justify-content-center mt-5">
        <div class="col-12 col-lg-8">
            <div class="bg-white border rounded shadow-sm p-5">
                <h5 class="mb-3 display-5 text-center">Edit Page</h5>
                <form id="pageForm" action="insert_page.php" method="POST">
                    <label for="page_name">Page Name:</label>
                    <input type="text" id="page_name" class="form-control" name="page_name" value="<?php echo $page_name; ?>" required><br>
                    
                    <label for="page_content">Page Content:</label>
                    <textarea id="page_content" class="form-control" name="page_content" value="<?php echo $content; ?>" required></textarea><br>
