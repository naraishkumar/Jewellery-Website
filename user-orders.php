...
if (isset($_SESSION["username"])) {
    $user_id = $_SESSION["id"];
    $sql = "SELECT tbl_orders.id, order_number, user_id, order_date, status, total_amount
            FROM tbl_orders 
                        ...
                        <tbody>
                            <?php                                
                                while ($row = $result->fetch_assoc()) {
                                        echo "<tr>";
                                        echo "<td> ORD#" . $row['order_number'] . "</td>";
                                        echo "<td>" . $row['order_date'] . "</td>";
                                        echo "<td>" . $row['status'] . "</td>";
                                        echo "<td>" . $row['total_amount'] . "</td>";
                                        echo "<td><a href='order-details.php?my-order=" . $row['order_number'] . "'><i class='fa-solid fa-eye'></i></td>";
                                        echo "</tr>";
